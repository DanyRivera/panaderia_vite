    ...
    return (
        <section className="mb-32" id="contacto">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-5 text-center md:mx-24 gap-10 md:gap-24">
                <a className="bg-primary cursor-pointer flex items-center justify-center md:rounded-full py-10 md:py-[3rem] md:px-[4.5rem] 2xl:py-[5rem] 2xl:text-6xl text-5xl text-white md:hover:bg-[#53afac] transition-all">
