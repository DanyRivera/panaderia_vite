    ...
    return (
        <header >
            ...
            <div className="bg-image flex flex-col justify-center items-center">
                <h2 className="font-merienda font-bold text-white z-20 text-5xl text-center px-5 tracking-wide leading-relaxed md:text-7xl md:leading-snug md:mt-10">El mejor lugar para el Pan y Pasteles</h2>
                <button
