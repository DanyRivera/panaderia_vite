    ...
    return (
        <header >
            ...
            <div className="bg-image flex flex-col justify-center items-center">
                ...
                <Link
                    className="font-merienda z-20 bg-primary text-white px-6 py-3 mt-14 rounded-md outline-none md:text-2xl md:px-10 md:hover:bg-[#53afac] transition-all cursor-pointer"
                    to="contacto"
                    smooth={true}
                    duration={1000}
                    offset={-150}
