  ...
  return (
    <main className="my-24 mx-5 md:mx-24">
      ...
      <div className="md:grid grid-cols-3 md:gap-20 ld:gap-40 mt-10">
        ...
        {[1, 2, 3].map(card => (
          <div key={card} className="hover:bg-primary text-primary hover:text-white text-center mb-10 py-5 rounded-lg shadow-xl md:shadow-2xl transition-all md:hover:scale-105">
